    ...
    def allowed_chat(update, context, *args, **kwargs):
        ...
        if isAllowed or chat.type == "private":
            ...
            update.effective_message.reply_text(
                "It's Private Group only stuffs, if you want ask for approval [Here](https://telegram.dog/TheHeadHunterZ) or [Here](https://telegram.dog/HackfreaksSupport)"
            )
    return allowed_chat
